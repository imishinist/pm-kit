...
6. Run `uv run --project <pm-kit repo root> pm-kit adapter claude` to generate Claude Code configuration files (cwd must be the project directory; the pm-kit repo root is the directory where this skill file resides)
